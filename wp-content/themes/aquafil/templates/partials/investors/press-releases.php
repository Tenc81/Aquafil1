  ...
  <div class="page--investors__accordion-item" <?=setAnchor($accordion);?>>
    ...
    <div class="page--investors__accordion-content" id="<?= sanitize_title($accordion['titolo_accordion']); ?>-content">
      <div class="page--investors__downloads">
              ...
              <a href="'.$download['download_file']['url'].'" download="'.$content['contenuto']['filename'].'" class="btn--investor"><span>'.strtoupper($content['contenuto']['subtype']).' - '.$filesize.'</span> <span class="icon"><svg><use xlink:href="#download"></use></svg></span></a>
						</div>';
				}
				?>
      </div>    
