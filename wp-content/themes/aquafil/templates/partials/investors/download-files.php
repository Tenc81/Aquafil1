		...
		foreach($_args['section']['download_files'] as $download) {
			...
			echo '
				<div class="page--investors__downloads-item">
					...
					<a href="#" download="'.$download['download_file']['filename'].'" class="btn--investor"><span>'.strtoupper($download['download_file']['subtype']).' - '.$filesize.'</span> <span class="icon"><svg><use xlink:href="#download"></use></svg></span></a>
				</div>';
		}
		echo '
			</div>';
